...
export class ChatEntities1698363195805 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "avatars" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "avatars" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
