...
export class FriendAndBlock1698625454704 implements MigrationInterface {
  name = 'FriendAndBlock1698625454704';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_cbf6fee21ed86e16e040b3e9aa" ON "friends" ("profileId", "friendId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_9ee3e5c2db55ed0caf60661e67" ON "blocks" ("profileId", "blockedUserId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9ee3e5c2db55ed0caf60661e67"`,
    );
    await queryRunner.query(`DROP TABLE "blocks"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cbf6fee21ed86e16e040b3e9aa"`,
    );
