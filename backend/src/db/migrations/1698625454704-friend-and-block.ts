...
export class FriendAndBlock1698625454704 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_9ee3e5c2db55ed0caf60661e67" ON "blocks" ("profileId", "blockedUserId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9ee3e5c2db55ed0caf60661e67"`);
