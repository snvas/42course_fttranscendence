...
<div class="h-full min-h-screen w-full min-w-screen flex flex-col lg:h-screen lg:w-screen">
	...
	<div class="flex-1 first-letter:w-full flex h-0 lg:flex-row flex-col gap-10 p-10 min-w-3xl">
		...
		<div class="flex flex-col lg:w-1/3 w-full h-full md:order-2 order-first gap-10">
		...
		<div class="gap-15 flex flex-col justify-start lg:w-1/3 w-full h-full md:order-2 order-last">
			<UsersList
				users={$onlineUsers}
